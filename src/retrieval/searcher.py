...
from src.db.queries import SEARCH_CHUNKS, fmt_vector
from src.schemas.internal import CandidateChunk, FullBiasDocument


def _row_to_candidate(row: asyncpg.Record) -> CandidateChunk:
    # asyncpg decodes JSONB columns to dicts automatically via its built-in codec.
...
async def search_chunks(
    ...
    """
    vector_str = fmt_vector(embedding)
