...
- **FR-004**: The system MUST generate new synthetic training stories using genuinely different generation sources (not superficially different variants of the same source), spread across all four evaluation scenario groups.
